...
const startServer = async () => {
  try {
    ...
    app.get('/api', (req, res) => {
      res.status(200).json({
        success: true,
        message: 'BTCBOT24 API Server with Next.js SSR',
        version: '1.0.0',
        endpoints: {
        ...
        documentation: 'https://docs.btcbot24.com',
        support: 'support@btcbot24.com',
    ...
    const server = app.listen(PORT, HOST, () => {
      ...
      console.log(`
🚀 BTCBOT24 Full-Stack Server Started Successfully!
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
