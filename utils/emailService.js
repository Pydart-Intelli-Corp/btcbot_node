...
const emailTemplates = {
  otpVerification: (firstName, otp) => ({
    subject: 'BTCBOT24 - Your Email Verification Code',
    html: `
      <!DOCTYPE html>
      <html>
      <head>
        ...
        <style>
          ...
          .otp-code { font-size: 32px; font-weight: bold; color: #667eea; background: #f8f9ff; padding: 20px; border-radius: 10px; margin: 20px 0; letter-spacing: 8px; border: 2px dashed #667eea; }
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            <h2>Hi ${firstName}!</h2>
            <p>Thank you for registering with BTCBOT24. To complete your registration, please use the verification code below:</p>
            ...
            <div class="security-note">
              ...
              <ul style="text-align: left; display: inline-block;">
                ...
                <li>BTCBOT24 will never ask for your code via phone or email</li>
              </ul>
            </div>
            
            <p>If you didn't create an account with BTCBOT24, please ignore this email and ensure your email account is secure.</p>
          </div>
          <div class="footer">
            <p>&copy; 2024 BTCBOT24. All rights reserved.</p>
  ...
  verification: (firstName, verificationLink) => ({
    subject: 'Verify Your BTCBOT24 Account',
    html: `
      <!DOCTYPE html>
      <html>
      <head>
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            <h2>Hi ${firstName}!</h2>
            <p>Thank you for registering with BTCBOT24. To complete your registration and start trading, please verify your email address.</p>
            <p>Click the button below to verify your account:</p>
            <a href="${verificationLink}" class="button">Verify My Account</a>
            <p>If the button doesn't work, copy and paste this link into your browser:</p>
            <p style="word-break: break-all; color: #667eea;">${verificationLink}</p>
            <p><strong>This verification link will expire in 24 hours.</strong></p>
            <p>If you didn't create an account with BTCBOT24, please ignore this email.</p>
          </div>
          <div class="footer">
            <p>&copy; 2024 BTCBOT24. All rights reserved.</p>
            <p>This is an automated email. Please do not reply to this message.</p>
  ...
  welcome: (firstName) => ({
    subject: 'Welcome to BTCBOT24 - Your Trading Journey Begins!',
    html: `
      <!DOCTYPE html>
      <html>
      <head>
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Welcome to BTCBOT24</title>
        <style>
          body { font-family: Arial, sans-serif; margin: 0; padding: 0; background-color: #f4f4f4; }
          .container { max-width: 600px; margin: 0 auto; background-color: white; padding: 20px; }
          .header { text-align: center; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 30px; border-radius: 10px 10px 0 0; }
      ...
      <body>
        <div class="container">
          <div class="header">
            <h1>🎉 Welcome to BTCBOT24!</h1>
            <p>Your account has been verified successfully</p>
          </div>
          <div class="content">
            <h2>Hi ${firstName}!</h2>
            <p>Congratulations! Your BTCBOT24 account is now active and ready for trading.</p>
  ...
  passwordReset: (firstName, resetLink) => ({
    subject: 'BTCBOT24 - Password Reset Request',
    html: `
      <!DOCTYPE html>
      <html>
      <head>
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            <h2>Hi ${firstName}!</h2>
            <p>We received a request to reset the password for your BTCBOT24 account.</p>
