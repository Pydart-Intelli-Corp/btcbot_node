            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                <button
                  ...
                  className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-3 rounded-lg font-medium hover:from-blue-700 hover:to-purple-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
                >
                  Verify Code
                </button>
                ...
                <button
                  ...
                  className="w-full text-blue-600 px-6 py-2 rounded-lg font-medium hover:text-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                >
          ...
          <div className="text-center">
            ...
            <div className="space-y-3">
              {!userInfo?.token && (
                <Link 
                  href="/login"
                  className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-3 rounded-lg font-medium hover:from-blue-700 hover:to-purple-700 transition-all duration-200 inline-block text-center"
                >
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-sm text-gray-600">Email Verification</p>
        </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-xs text-gray-500 mb-2">
            ...
            <a href="mailto:support@btcbot24.com" className="text-blue-600 hover:text-blue-500">
              support@btcbot24.com
            </a>
          </p>
