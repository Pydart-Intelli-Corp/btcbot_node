              ...
              <div className="px-8 py-6 prose prose-gray max-w-none">
                ...
                >
                  ...
                  <div className="space-y-4 text-gray-700">
                    <p>
                      This Privacy Policy explains how BTCBOT24 ("we," "our," or "us") collects, uses, 
                ...
                >
                  ...
                  <div className="space-y-4 text-gray-700">
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                      <p className="text-sm text-blue-800">
                        To exercise your rights, contact us at <strong>privacy@btcbot24.com</strong>. 
                    ...
                    <div className="bg-green-50 border border-green-200 rounded-lg p-6">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <div className="space-y-1 text-sm text-green-800">
                            <p><strong>Email:</strong> privacy@btcbot24.com</p>
                        ...
                        <div>
                          ...
                          <div className="space-y-1 text-sm text-green-800">
                            <p><strong>Email:</strong> support@btcbot24.com</p>
                      ...
                      <div className="mt-4 pt-4 border-t border-green-200">
                        <p className="text-sm text-green-800">
                          ...
                          BTCBOT24 Privacy Department<br />
