              ...
              <div className="px-8 py-6 border-b border-gray-200">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">BTCBOT24 Trading Platform</p>
                  </div>
                </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <p className="text-sm text-yellow-800">
                        ...
                        By accessing or using BTCBOT24, you agree to be bound by these terms.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="px-8 py-6 prose prose-gray max-w-none">
                ...
                >
                  ...
                  <div className="space-y-4 text-gray-700">
                    <p>
                      By accessing, browsing, or using the BTCBOT24 platform ("Platform"), you acknowledge 
                    ...
                    <p>
                      ...
                      and BTCBOT24 ("Company," "we," "us," or "our"). If you do not agree to these Terms, 
                ...
                >
                  ...
                  <div className="space-y-4 text-gray-700">
                    <p>
                      BTCBOT24 is an automated cryptocurrency trading platform that provides:
                    </p>
                ...
                >
                  ...
                  <div className="space-y-4 text-gray-700">
                    <p>
                      ...
                      text, graphics, logos, images, software, and design, are owned by BTCBOT24 and are 
                  ...
                  <div className="space-y-4 text-gray-700">
                    <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                      <p className="text-sm text-gray-800">
                        <strong>Disclaimer:</strong> To the maximum extent permitted by law, BTCBOT24 
                  ...
                  <div className="space-y-4 text-gray-700">
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                      <div className="space-y-2">
                        <p><strong>Email:</strong> legal@btcbot24.com</p>
                        <p><strong>Support:</strong> support@btcbot24.com</p>
              ...
              <div className="px-8 py-6 border-t border-gray-200 bg-gray-50">
                <div className="flex items-center justify-between">
                  <div className="text-sm text-gray-600">
                    <p>© 2025 BTCBOT24. All rights reserved.</p>
