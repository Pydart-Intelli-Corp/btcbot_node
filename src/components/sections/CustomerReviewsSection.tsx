...
const CustomerReviewsSection = () => {
  ...
  const reviews = [
    {
      name: "Adrian",
      review: "BTCBOT24's precision trading is a game-changer, consistently delivering impressive profits. I trust it for my financial success.",
      rating: 5,
      avatar: "👨‍💼"
    },
    {
      name: "Madison",
      review: "Effortless trading with BTCBOT24. Its adaptability and data-driven approach make it a standout choice. Highly recommended!",
      rating: 5,
      avatar: "👩‍💼"
    },
    {
      name: "Schneider",
      review: "Seamless trades, constant profits - BTCBOT24 simplifies trading. It's a must-have for anyone in the market.",
      rating: 5,
      avatar: "👨‍🔬"
    },
    {
      name: "Tommy",
      review: "BTCBOT24's innovative strategies and consistent returns have transformed my trading experience. It's a valuable asset to any trader.",
      rating: 4,
      avatar: "👨‍💻"
    },
    {
      name: "Jannet",
      review: "I rely on BTCBOT24 for its adaptability in fluctuating markets. It's a proven partner in achieving financial goals.",
      rating: 5,
      avatar: "👩‍💻"
    },
    {
      name: "Thomas",
      review: "BTCBOT24's automated precision is remarkable. It's a powerful tool for navigating today's complex trading landscape.",
      rating: 4,
      avatar: "👨‍🚀"
    },
    {
      name: "Atlan",
      review: "Maximized profits with BTCBOT24. Its results speak volumes. A reliable and intelligent trading companion.",
      rating: 5,
      avatar: "👨‍🎨"
    },
    {
      name: "Kelvin",
      review: "Trading with BTCBOT24 is effortless and rewarding. It adapts to market changes seamlessly. Truly impressive!",
      rating: 5,
      avatar: "👨‍🔧"
    },
    {
      name: "Jude",
      review: "BTCBOT24 has changed my trading game. Its data-driven approach delivers consistent gains. An invaluable tool for success.",
      rating: 5,
      avatar: "👨‍🎓"
    },
    {
      name: "Jake",
      review: "Effortless trading made possible by BTCBOT24. Its strategic prowess sets it apart. A game-changer for traders.",
      rating: 5,
      avatar: "👨‍⚖️"
    }
  ];
