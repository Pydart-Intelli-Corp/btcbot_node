        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative" data-profile-dropdown>
              ...
              {isProfileOpen && (
                <div className="absolute right-0 mt-2 w-64 bg-white rounded-xl shadow-2xl border-2 border-gray-300 py-2 z-[9999] ring-1 ring-black ring-opacity-10 backdrop-blur-sm">
                  <div className="px-4 py-3 border-b border-gray-200 bg-slate-50 rounded-t-xl">
                    <p className="text-sm font-bold text-gray-900">
                      {user ? `${user.firstName || 'User'} ${user.lastName || ''}`.trim() : 'User Profile'}
                    </p>
                    <p className="text-xs font-medium text-gray-700">{user?.email || 'user@example.com'}</p>
                    {user?.currentRank && (
                      <div className="mt-2">
                        <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${getRankColor(user.currentRank)}`}>
                          <Crown className="h-3 w-3 mr-1" />
                  ...
                  <Link
                    href="/profile"
                    className="flex items-center space-x-3 px-4 py-3 text-sm font-bold text-black hover:bg-blue-50 hover:text-blue-800 transition-colors border-b border-gray-100"
                    onClick={() => setIsProfileOpen(false)}
                  >
                    <Settings size={16} className="text-black" />
                    <span className="font-bold text-black">Profile Settings</span>
                  </Link>
                  ...
                  <button
                    ...
                    className="flex items-center space-x-3 w-full px-4 py-3 text-sm font-bold text-red-600 hover:bg-red-50 hover:text-red-800 transition-colors rounded-b-xl"
                  >
