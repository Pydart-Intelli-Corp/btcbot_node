      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
            Recent Trades by <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">BTCBOT24</span>
          </h2>
          <p className="text-gray-700 text-lg max-w-3xl mx-auto">
            Real-time trading activity powered by our AI algorithms. Watch as BTCBOT24 
