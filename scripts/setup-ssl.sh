...
# BTCBOT24 SSL Setup Script with Let's Encrypt
...
# Configuration
DOMAIN="${1:-btcbot24.com}"
EMAIL="${2:-btcclub48@gmail.com}"
NGINX_CONFIG="/etc/nginx/sites-available/btcbot24"
...
print_usage() {
    ...
    echo "Example: $0 btcbot24.com admin@btcbot24.com"
    echo ""
...
check_prerequisites() {
    ...
    if [ -z "$DOMAIN" ] || [ "$DOMAIN" = "btcbot24.com" ]; then
...
# BTCBOT24 SSL-Enabled Nginx Configuration
...
server {
    ...
    location /api/auth {
        ...
        proxy_pass http://btcbot24_backend;
    ...
    location /uploads/ {
        alias /var/www/btcbot24/uploads/;
        expires 30d;
...
main() {
    log "${CYAN}🔐 Starting SSL setup for BTCBOT24...${NC}"
